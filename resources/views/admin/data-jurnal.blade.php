    ...
    <div class="top">
        ...
        <div class="search-box">
            ...
            <form action="{{ route('jurnal.index') }}" method="GET" class="d-flex align-items-center" style="gap:.5rem;">
                <input type="text" name="q" value="{{ $q ?? '' }}" placeholder="Cari nama/link/edisi/sinta/tahun...">
                        ...
                        @forelse ($jurnal as $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    <span class="badge bg-primary">S{{ $item->sinta }}</span>
                                </td>
                    ...
                    <div class="row">
                        <div class="col-4 mb-3">
                            ...
                            <select name="sinta" class="form-select" required>
                                @for ($i=1; $i<=6; $i++)
                                    <option value="{{ $i }}" {{ (int)$item->sinta === $i ? 'selected' : '' }}>S{{ $i }}</option>
                                @endfor
                            </select>
                        </div>
                            ...
                            @foreach ($bulanAll as $b)
                                <div class="col-4">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label text-uppercase" for="ed-{{ $item->id }}-{{ $b }}">
                                            {{ $labelBulan[$b] }}
                                        </label>
                                    </div>
                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8 mb-3">
                            <label class="form-label">Tahun Akreditasi</label>
                            <input type="number" name="tahun_akreditasi" class="form-control" min="2000" max="2100" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <div class="row g-2">
                            @foreach ($bulanAll as $b)
                                <div class="col-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="add-ed-{{ $b }}" name="edisi[]" value="{{ $b }}">
                                        <label class="form-check-label text-uppercase" for="add-ed-{{ $b }}">
                                            {{ $labelBulan[$b] }}
                                        </label>
                                    </div>
                                </div>
    ...
    $(function() {
        $('#datatable').DataTable({
            ...
            language: {
                ...
                paginate: {
                    first: 'Awal', last: 'Akhir', next: 'Selanjutnya', previous: 'Sebelumnya'
                }
            }
        });
    });
