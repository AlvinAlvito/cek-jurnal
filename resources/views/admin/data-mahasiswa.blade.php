...
<section class="dashboard">
    <div class="top">
        ...
        <div class="search-box">
            ...
            <form action="{{ route('mahasiswa.index') }}" method="GET" class="d-flex align-items-center" style="gap:.5rem;">
            ...
            <div class="row justify-content-end mb-3">
                <div class="col-lg-3 text-end">
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalTambah">
                        <i class="uil uil-plus"></i> Tambah Mahasiswa
                    </button>
                </div>
            </div>
        ...
        <form action="{{ route('mahasiswa.update', $item->id) }}" method="POST">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalEditLabel{{ $item->id }}">Edit Mahasiswa</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nim" class="form-control" value="{{ $item->nim }}" required maxlength="50">
                    </div>
                </div>
        ...
        <form action="{{ route('mahasiswa.store') }}" method="POST">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label class="form-label">Nama</label>
                        <input type="text" name="nama" class="form-control" required maxlength="150" placeholder="Contoh: Paris Alvito">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">NIM</label>
                        <input type="text" name="nim" class="form-control" required maxlength="50" placeholder="Contoh: 211201234">
                    </div>
                </div>
